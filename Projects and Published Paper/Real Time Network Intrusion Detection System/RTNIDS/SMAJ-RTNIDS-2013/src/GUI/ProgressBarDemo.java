...
public class ProgressBarDemo extends JPanel, implements ActionListener,PropertyChangeListener {
    ...
    }             int progress = 0;             //Initialize progress property. setProgress(0);  
        while (progress < 100) {                 //Sleep for up to one second.  
...
task.execute();     }       /**      * Invoked when task's progress property changes.      */    
